...
Route::middleware([Admin::class])->group(function () {
    ...
    Route::post('/order/{order}/konfirmasi', [OrderController::class, 'konfirmasi_bayar'])->name('konfirmasi_bayar');
});
...
Route::middleware(('auth'))->group(function () {
    ...
    Route::patch('/order/{order}/bayar', [OrderController::class, 'bukti_bayar_order'])->name('bukti_bayar_order');


    Route::get('/profile', [ProfileController::class, 'show_profile'])->name('show_profile');
    Route::post('/profile/{profile}/edit', [ProfileController::class, 'edit_profile'])->name('edit_profile');
});
